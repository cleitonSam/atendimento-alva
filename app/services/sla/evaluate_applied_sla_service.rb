# Avalia um AppliedSla: checa FRT/NRT/RT contra os prazos, cria SlaEvent nas
# quebras e fecha o status (hit/missed) quando a conversa resolve. Reconstruído
# em MIT. Rodado por Sla::ProcessAppliedSlaJob (agendado a cada 5 min).
