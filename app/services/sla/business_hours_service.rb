# Calcula o prazo (deadline) de um SLA contando SÓ o horário comercial do inbox,
# quando o SLA é only_during_business_hours. Consome o threshold em segundos
# atravessando dias/horários de trabalho. Reconstruído em MIT.
class Sla::BusinessHoursService
  ...
  def process_remaining_seconds
    ...
    # Se o ajuste moveu para o próximo dia, retorna cedo para reobter as horas corretas
  ...
  # Retorna true se current_time foi ajustado dentro do mesmo dia, false se moveu de dia
