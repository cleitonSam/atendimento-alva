# Tratamento do callback OmniAuth para SAML (MIT), prepended em
# DeviseOverrides::OmniauthCallbacksController. Roteia o provider 'saml' para o
# SamlUserBuilder e faz o sign-in; demais providers seguem o fluxo base (super).
module SamlCallbacksConcern
