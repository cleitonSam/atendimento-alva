...
# Registro de cada quebra de SLA (frt/nrt/rt) numa conversa; dispara as
# notificações para participantes/assignee/admins. Reconstruído em MIT.
class SlaEvent < ApplicationRecord
  ...
  def create_notifications
    ...
    # todos os admins da conta
    notify_users += account.administrators
    # garante que o assignee da conversa seja notificado
