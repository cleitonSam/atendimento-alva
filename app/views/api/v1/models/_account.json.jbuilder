...
if resource.custom_attributes.present?
  json.custom_attributes do
    ...
    json.billing_currency resource.billing_currency if resource.respond_to?(:billing_currency) && defined?(Enterprise::Billing::Currencies) && Enterprise::Billing::Currencies.enabled?
