export default {
  computed: {
    ...
    hasAConnectedAgentBot() {
      return !!window.alvaWebChannel.hasAConnectedAgentBot;
    },
    inboxAvatarUrl() {
      return window.alvaWebChannel.avatarUrl;
    },
    channelConfig() {
      return window.alvaWebChannel;
    },
    ...
    preChatFormEnabled() {
      return window.alvaWebChannel.preChatFormEnabled;
    },
    preChatFormOptions() {
      let preChatMessage = '';
      const options = window.alvaWebChannel.preChatFormOptions || {};
