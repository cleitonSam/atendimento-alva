# Enforcement de cargos personalizados (MIT) — prepended em ConversationPolicy.
# Restringe o acesso a conversas conforme as permissões do custom_role do agente.
# Precedência: precisa passar no acesso base (super = inbox/team); com custom_role,
# restringe ainda mais (gerir tudo / não-atribuídas / participando).
