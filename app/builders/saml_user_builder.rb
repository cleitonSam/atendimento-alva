# Cria/associa o usuário a partir da resposta SAML do IdP, aplicando role_mappings
# (grupo do IdP -> role/custom_role). Reconstruído em MIT.
class SamlUserBuilder
  ...
  def saml_groups
    # Grupos podem vir de atributos diferentes conforme o IdP
